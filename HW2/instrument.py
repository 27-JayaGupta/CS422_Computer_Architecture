...
config = {
    "spec_dir":"/home/jaya/pin-3.28-98749-g6643ecee5-gcc-linux/source/tools/CS422_Computer_Architecture/HW2/spec_2006",
    "pin_exec": "/home/jaya/pin-3.28-98749-g6643ecee5-gcc-linux/pin",
    "pintool": "/home/jaya/pin-3.28-98749-g6643ecee5-gcc-linux/source/tools/CS422_Computer_Architecture/HW2/obj-ia32/HW2.so",
    "hw_dir": "/home/jaya/pin-3.28-98749-g6643ecee5-gcc-linux/source/tools/CS422_Computer_Architecture/HW2"
}
...
def recompile_pintool():
    ...
    try:
        ...
        pass
    res = subprocess.run(["make TARGET=ia32 obj-ia32/HW2.so"], text=True,shell=True)
    if res.returncode != 0:
